    ...
    <main className="min-h-screen bg-slate-100">
      <div className="mx-auto max-w-5xl px-4 py-8">
        ...
        <div className="mt-8 space-y-10 rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <Section title="5. 推定レンジの使い方">
            <p className="text-sm leading-7 text-slate-600">
              保守、標準、強気は「推定値のブレ幅」を見るために使います。画面では、Copies soldやGross revenueの括弧内レンジ、
              そして「推定販売本数・売上」テーブルの3行として表示します。通常の比較では標準ケースを中心値として見て、
              慎重に判断したい時は保守、上振れ可能性を見たい時は強気を確認します。
            </p>
            <Formula>保守所有者 = 標準所有者 × 0.75</Formula>
            <Formula>強気所有者 = 標準所有者 × 1.25</Formula>
            <p className="text-sm leading-7 text-slate-600">
              売上側は、所有者数のブレに加えて有効販売価格係数も保守45%、標準60%、強気75%に分けます。
              このレンジは統計的な信頼区間ではありません。レビュー倍率法の不確実性を、競合比較や事業計画で扱いやすくするための実務的な目安です。
            </p>
          </Section>
